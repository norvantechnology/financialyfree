...
export const metadata: Metadata = {
  title: 'Sign In | Aureus / FinanciallyFree Research Room',
  description: 'Sign in to access your research room',
};
...
export default function LoginPage() {
  return (
    ...
    >
      {/* Centered White Card (Screenshot 1 Match) */}
      <div
        className="card"
        style={{
          width: '100%',
      ...
      >
        ...
        <div style={{ textAlign: 'center', marginBottom: 'var(--space-6)' }}>
          ...
          <p style={{ color: 'var(--text-secondary, #4B5563)', fontSize: '13px' }}>
            Sign in to access your research room
          </p>
        </div>
      ...
      >
        ...
        <span>AMFI Registered Distributor ARN-350272 • 256-bit SSL Encrypted</span>
      </div>
    </div>
  );
}
